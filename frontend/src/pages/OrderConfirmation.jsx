                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="bg-stone-50 border border-stone-200/60 rounded-lg p-6 shadow-sm">
                            <h3 className="text-lg font-serif text-stone-900 mb-4 flex items-center gap-2">
                            ...
                            <div className="divide-y divide-stone-200">
                                {order.orderItems.map((item, idx) => (
                                    <div key={idx} className="flex items-center gap-4 py-4">
                                        ...
                                        <p className="text-stone-850 font-medium">${(item.price * item.qty).toLocaleString()}</p>
                                    </div>
                                ))}
                            </div>
                        </div>
                        ...
                        <div className="bg-stone-50 border border-stone-200/60 rounded-lg p-6 shadow-sm">
                            ...
                            <p className="text-stone-900">{order.shippingAddress.fullName}</p>
                            <p className="text-stone-600 text-sm">{order.shippingAddress.address}</p>
                    ...
                    <div className="bg-stone-50 border border-stone-200/60 p-6 h-fit sticky top-28 rounded-lg shadow-sm">
                        <h3 className="text-lg font-serif text-stone-900 mb-5 pb-4 border-b border-stone-200">Price Summary</h3>
                        ...
                        <div className="flex justify-between text-stone-900 text-lg font-semibold pt-4 border-t border-stone-200">
                        ...
                        <div className="mt-8 space-y-3">
                            ...
                            <Link to="/shop"
                                className="block w-full text-center border border-stone-300 bg-white text-stone-600 font-semibold uppercase tracking-widest text-sm py-3 hover:border-gemRed hover:text-gemRed hover:bg-stone-50 transition-all duration-300 rounded">
                                Continue Shopping
                            </Link>
                        </div>
                    </div>
